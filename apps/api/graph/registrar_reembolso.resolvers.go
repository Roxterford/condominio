...
// TxRegistrarReembolso is the resolver for the txRegistrarReembolso field.
func (r *mutationResolver) TxRegistrarReembolso(ctx context.Context, input model.RegistrarReembolsoInput) (bool, error) {
